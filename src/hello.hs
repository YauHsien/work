...
fizzbuzzRun1 n m (0, k) = FizzBuzz n "fizz" : fizzbuzzRun1 (n+1) m (1, (k+1) `mod` 5)
fizzbuzzRun1 n m (k, 0) = FizzBuzz n "buzz" : fizzbuzzRun1 (n+1) m ((k+1) `mod` 3, 1)
fizzbuzzRun1 n m (k, l) = Num n : fizzbuzzRun1 (n+1) m ((k+1) `mod` 3, (l+1) `mod` 5)
